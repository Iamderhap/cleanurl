    ...
    return (
        <div>
            <nav className='flex items-center justify-between md:justify-around w-full px-[20px] md:px-[70px] py-[30px] bg-black'>
                <a className='text-white text-3xl font-bold ' href='/'>Cleanurl.site</a>
                <div>
                ...
                <div>
                <button onClick={handleMenu} className='flex md:hidden text-white font-bold text-25px p-4'>{menu ? <IoCloseSharp/> : <IoMdMenu/>}</button>
