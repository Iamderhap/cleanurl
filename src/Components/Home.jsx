...
const Home = () => {
  ...
  return (
    <>
        ...
        <div>
            <h1 className='text-white md:text-4xl text-2xl  pb-5 text-center'>PASTE A LINK TO SHORTEN IT</h1>
        </div>
            <div>
                <input className='md:w-[30vw] w-[35vw] h-[7vh] border-2 border-black rounded-lg px-[10px]' type="text"placeholder='shorten a link here'
                value={input} onChange={(e)=>setInput(e.target.value)} />
                <button className='h-[7vh] md:w-[8vw] w-[30vw] md:border-2 border-none rounded-md bg-green-500' onClick={fetchApi}>{isclick? "Pls wait ..":"Shorten"}</button>
            </div>
            <div>
